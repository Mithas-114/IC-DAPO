...
from verl.trainer.ppo.core_algos import compute_cispo_loss, compute_policy_loss_gspo
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.actor_loss_mode == "grpo":
                    ...
                    elif self.config.actor_loss_mode == "cispo":
                        pg_loss, pg_clipfrac, ppo_kl, pg_clipfrac_lower = compute_cispo_loss(
                            old_log_prob=old_log_prob,
                            log_prob=log_prob,
                            advantages=advantages,
                            response_mask=response_mask,
                    ...
                    elif self.config.actor_loss_mode == "gspo":
                        ...
                        raise NotImplementedError("Only support grpo/cispo/gspo loss.")
