#!/usr/bin/env bash
# =============================================================================
# IC-DAPO-R1 debug on DeepSeek-R1-Distill-Qwen-1.5B (1 node, 8 GPUs)
# Single-node debug configuration with reduced batch/sequence sizes
# =============================================================================
...
CKPTS_SAVE_DIR="${PROJECT_ROOT}/ckpt/icdapo-r1-1.5b-debug"
...
few_shot_example_file="${PROJECT_ROOT}/datasets/train/demonstrations_r1.jsonl"
num_few_shot=1
...
project_name='icdapo'
exp_name='icdapo_r1_1.5B_math_debug'
...
# Reduced sequence lengths for debug
max_prompt_length=$((1024 * 8))
max_response_length=$((1024 * 1))
val_response_length=$((1024 * 1))
