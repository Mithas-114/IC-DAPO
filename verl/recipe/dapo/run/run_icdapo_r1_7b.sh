#!/usr/bin/env bash
# =============================================================================
# IC-DAPO-R1 training on DeepSeek-R1-Distill-Qwen-7B (8 nodes, 64 GPUs)
# In-context DAPO with R1-style few-shot examples
# =============================================================================
...
YOUR_MODEL_PATH=""  # e.g., "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B"
CKPTS_SAVE_DIR="${PROJECT_ROOT}/ckpt/icdapo-r1-7b"
