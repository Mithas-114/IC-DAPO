#!/usr/bin/env bash
# =============================================================================
# DAPO baseline training on DeepSeek-R1-Distill-Qwen-7B (16 nodes, 128 GPUs)
# =============================================================================
...
CKPTS_SAVE_DIR="${PROJECT_ROOT}/ckpt"
YOUR_TRAIN_FILE="${PROJECT_ROOT}/datasets/train/train_math_30K.json"
