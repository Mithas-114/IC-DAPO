...
from .dapo_fewshots_ray_trainer import RayDAPOFewshotTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        reward_fn = reward_manager_cls(
            ...
            overlong_filter=config.actor_rollout_ref.actor.overlong_filter
        )
