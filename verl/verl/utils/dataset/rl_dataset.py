        ...
        for parquet_file in self.data_files:
            ...
            try:
                ...
                try:
                    ...
                    # dataframe = datasets.load_dataset("json", data_files=json_file)["train"]
                    pandas_df = pd.read_json(json_file, orient='records')
                    # Convert pandas DataFrame to Hugging Face Dataset
                    dataframe = datasets.Dataset.from_pandas(pandas_df)
